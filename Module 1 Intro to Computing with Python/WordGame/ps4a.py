...
def isValidWord(word, hand, wordList):
    ...
    if word in wordList:
        for i in word:
            if hand3.get(i,0) == 0:
                #remove the letter in the hand when the letter is played
                # if the letter isn't in the hand
                # OR the letter is 0, we can't form this word.
                # so return false.
                return False
            else:
                hand3[i] -= 1
    ...
    while calculateHandlen(hand) != 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                #update score
               case_score = getWordScore(word, n) 
               score = case_score + score
               print( ' " '  + word + ' " ' + "earned him " + str(case_score) + " points." + "Total:" + str(score))
                # Update the hand 
               print()
